...
URL = "http://searchxh.news.cn/was5/web/search?channelid=229767&searchword=%E5%88%86%E5%B8%83%E5%BC%8F%E5%8F%91%E7%94%B5&prepage=&page=" ### need modification key word ####
...
#page info
num_count = 130                                ############ need modification of rec count ##############333333
    ...
    def run(self):
        ...
        for i in self.llist:
            ...
            for j in range(len(a_list)):
                ...
                try:
                    LOCK.acquire()
                    sql = "insert into energy_bureau_dis_generator values(%s,%s,%s,%s)" 
