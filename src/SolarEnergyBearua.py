...
URL = "http://searchxh.news.cn/was5/web/search?channelid=229767&searchword=%E5%A4%AA%E9%98%B3%E8%83%BD&prepage=&page="
    ...
    def run(self):
        ...
        for i in self.llist:
            ...
            for i in range(len(a_list)):
                ...
                try:
                    LOCK.acquire()
                    sql = "insert into url_solar_energy_bearua values(%s,%s,%s,%s)" 
