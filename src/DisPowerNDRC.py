...
rec_num = 84                                                               #########################  need modification  ####################
rec_list = [i for i in range(1,rec_num/FORM_DATA['pageSize']+2)]              #################  9 pages ######################
    ...
    def run(self):
        ...
        for i in self.llist:
            ...
            for j in range(len(resultset_a)):
                ...
                try:
                    LOCK.acquire()
                    sql = "insert into ndrc_dis_generator values(%s,%s,%s,%s)"   ################# need modification of table ####################
